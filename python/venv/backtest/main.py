...
def predict_future(model, scaler, last_sequence, days):
    ...
    for _ in range(days):
        ...
        new_data_point[0, :-1] = current_sequence_scaled[-1]  # 스케일링된 특성값 사용
        new_data_point[0, -1] = prediction[0][0]  # 예측된 target 값
        ...
        result_data = [
            {
                ...
                'predicted_movement': 'Up' if pred > 0.5 else 'Down'
            }
