...
//             {/* 커뮤니티 게시글 리스트 */}
//             <Grid container spacing={3}>
//               {commCmtComplaint.map((cmt, index) => (
//                 <Grid item xs={12} key={index} style={{ cursor: 'pointer', marginBottom: '5px' }}>
//                   <BlankCard>
...
const CommDecComment = () => {
  ...
  const handleClickDetail = (commentId) => {
    navigate(`/manager/commentDetail/${commentId}`);
  };
